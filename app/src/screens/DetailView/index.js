...
import { ScrollView, View, Text, StyleSheet, Image, Button, Dimensions, TouchableOpacity } from 'react-native';
            ...
            <View style={styles.container}>
                ...
                <View style={{ flex: 8, backgroundColor: '#e6e6e6', padding: 5 }}>
                    <ScrollView>
                        ...
                        <View style={{ flex: 2, backgroundColor: '#1997a8', borderRadius: 10, marginBottom: 5 }}>
